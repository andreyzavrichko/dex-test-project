...
class RegistrationTest extends TestBase {
    ...
    @CsvSource(value = {
            ...
            "+++, Длина номера должна быть 11 символов",
            "///, Длина номера должна быть 11 символов",
            "///2, Длина номера должна быть 11 символов",
            "****, Длина номера должна быть 11 символов",
            "*--**, Длина номера должна быть 11 символов",
            "---, Длина номера должна быть 11 символов",
            "++++, Длина номера должна быть 11 символов",
    ...
    @Feature("Регистрация")
    @Story("Регистрация")
    @DisplayName("Регистрация - проверка ввода смс кода")
    @Severity(SeverityLevel.BLOCKER)
    @CsvSource(value = {
    ...
    @Feature("Регистрация")
    @Story("Регистрация")
    @DisplayName("Регистрация - проверка пароля")
    @Severity(SeverityLevel.BLOCKER)
    @CsvSource(value = {
    ...
    @Feature("Регистрация")
    @Story("Регистрация")
    @DisplayName("Регистрация - проверка подтверждения пароля")
    @Severity(SeverityLevel.BLOCKER)
    @CsvSource(value = {
            "!!!, Длина пароля должна быть больше 8 символов",
            ", Заполните обязательное поле",
